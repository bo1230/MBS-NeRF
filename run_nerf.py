...
def config_parser():
    ...
    # depth
    parser.add_argument("--colmap_depth", action='store_true', default=True,
    ...
    parser.add_argument('--gpu_id', type=int, default=1,
                        help='the gpu which you choose')
    parser.add_argument("--multi_view", action='store_true',
                        help='use multiple views')
    parser.add_argument("--N_rgb_rand", type=int, default=90,
                        help='batch size (number of random rays per gradient step)')
    parser.add_argument("--N_depth_rand", type=int, default=90,
                        help='batch size (number of random rays per gradient step)')
    parser.add_argument("--blur_rgb_lrate", type=float, default=1e-3,
                        help='learning rate')
    parser.add_argument("--blur_depth_lrate", type=float, default=1e-3,
                        help='learning rate')
    parser.add_argument("--i_train", nargs='+', type=int, default=[1, 17, 25],
                        help='batch size (number of random rays per gradient step)')
